...
// }
  ...
  Future getAddedData() async {
    dref.onChildAdded.listen((event) {
      Map<String, dynamic> dataInFirebase =
          event.snapshot.value as Map<String, dynamic>;
  ...
  void fetchOnce() {
    dref.once(DatabaseEventType.value).then((value) 
    {
      final once = value.snapshot.value;
    }
                                    ...
                                    TextButton(
                                        ...
                                        onPressed: () async {
                                          final ref = sref.child(
                                              'files/${val[index].part}.${val[index].ext}');
                                          getdownloadLink(ref,
                                              "${val[index].part}.${val[index].ext}");
                                          // setState(() {
                                          //   status1 = "Pending...";
                                          // });
